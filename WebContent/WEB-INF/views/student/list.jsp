        ...
        <table>
            <tr>
             ...
             <tr>
                ...
                <td>
                 	<select name="subjectId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择所属学科'">
	            	<option value="-1">全部</option>
	            	<c:forEach items="${subjectList}" var="subject">
	            		<option value="${subject.id }">${subject.name }</option>
	            	</c:forEach> 
            ...
            <tr>
                ...
                <td><input type="text" id="add-truename" name="name" class="wu-text" ></td>
            </tr>
            <tr>
                <td align="right">手机:</td>
                <td><input type="text" id="add-tel" name="name" class="wu-text"></td>
            </tr>
        </table>
    </form>
</div>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td align="right">考生名称:</td>
                <td><input type="text" id="edit-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写考生名称'" ></td>
            </tr>
            <tr>
                <td align="right">考生备注:</td>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'name',title:'考生名称',width:100,sortable:true},
			{ field:'remark',title:'考生备注',width:200},
		]]
	});
</script>